...
Original file is located at
    https://colab.research.google.com/drive/1vCRtnSVP5Hf-wVDJvLrEvAf1cP3cO__7
"""
...
# Finally, we present the data in graphs then export the data to files for our
# website
...
# energy consumption per day average
# energy consumption per month average
# energy consumption per year average
